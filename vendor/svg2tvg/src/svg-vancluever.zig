...
/// NOTE: paths parse incorrectly look at svg2 for path parsing:
/// i.e. this fails (implicit line to after relative move!)
...
fn testError(p: *Parser, expected: [:0]const u8) !void {
    var buf: [256:0]u8 = @splat(0); // dvui: `**` array repetition was removed from Zig master
